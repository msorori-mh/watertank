      ...
      <main className="max-w-2xl mx-auto px-5 py-6 space-y-6 text-sm leading-7">
        ...
        <Block title="البيانات التي نجمعها">
          <ul className="list-disc ps-5 space-y-1.5">
            <li><b>حساب Google</b>: نستخدم الاسم والبريد الإلكتروني وصورة الحساب الأساسية لتسجيل الدخول الآمن وإنشاء هويتك داخل التطبيق.</li>
            <li><b>رقم الهاتف</b>: يُطلب بعد تسجيل الدخول للتواصل بشأن الطلب والتوصيل، ولا يُستخدم لإرسال رمز دخول.</li>
        ...
        <Block title="مشاركة البيانات">
          <p>
            ...
            ومع فريق الإدارة داخل التطبيق لأغراض التشغيل والدعم. نستخدم Google لتسجيل الدخول، وSupabase
            للمصادقة واستضافة قاعدة البيانات وتخزين البيانات بشكل آمن. لا نطلب صلاحية الوصول إلى ملفاتك أو بريدك في Google.
          </p>
        </Block>
